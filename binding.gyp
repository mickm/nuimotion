      ...
      "conditions": [
        [ "OS=='win'", {
          "copies": [
            {
              "files": [
                "<(OPENNI2)/Redist/OpenNI2/Drivers/Kinect.dll",
            ...
            {
              "files": [
                "<(NITE2)/Redist/NiTE2/Data/lbsdata.idx",
            ...
            {
              "files": [
                "<(NITE2)/Redist/NiTE2/FeatureExtraction.ini",
        ...
        [ "OS=='linux'", {
          "copies": [
            {
              "files": [
                "<(OPENNI2)/Redist/OpenNI2/Drivers/libOniFile.so",
        ...
        [ "OS=='mac'", {
          "copies": [
            {
              "files": [
                "<(OPENNI2)/Redist/OpenNI2/Drivers/libOniFile.dylib",
            ...
            {
              "files": [
                "<(OPENNI2)/Redist/libOpenNI2.dylib",
                "<(OPENNI2)/Redist/OpenNI.ini",
          ...
          "libraries": [
            "<(OPENNI2)/Tools/libOpenNI2.dylib",
            "<(NITE2)/Redist/libNiTE2.dylib"
          ]
        }]
      ],
